...
//SLIDER XS 03
// $('#slider-xs-03').on('slide.bs.carousel', function onSlide (ev) {
//   var id = ev.relatedTarget.id;
//   var directionSlide = ev.direction;
  
//   switch (id) {
//     case "main-slider-xs-03-06":
//       if(directionSlide === "left") {
//         $('#item-slider-xs-03-06, #item-slider-xs-03-05, #item-slider-xs-03-04, #item-slider-xs-03-03, #item-slider-xs-03-02, #item-slider-xs-03-01').removeClass('animation-item-left');
//         $('#item-slider-xs-03-06, #item-slider-xs-03-05, #item-slider-xs-03-04, #item-slider-xs-03-03, #item-slider-xs-03-02, #item-slider-xs-03-01').removeClass('animation-item-right');
//         $('#item-slider-xs-03-06').addClass('animation-item-left');
//       } else{
//         $('#item-slider-xs-03-06, #item-slider-xs-03-05, #item-slider-xs-03-04, #item-slider-xs-03-03, #item-slider-xs-03-02, #item-slider-xs-03-01').removeClass('animation-item-left');
//         $('#item-slider-xs-03-06, #item-slider-xs-03-05, #item-slider-xs-03-04, #item-slider-xs-03-03, #item-slider-xs-03-02, #item-slider-xs-03-01').removeClass('animation-item-right');
//         $('#item-slider-xs-03-06').addClass('animation-item-right');
//       }
//       break;
//     case "main-slider-xs-03-05":
//       if(directionSlide === "left") {
//         $('#item-slider-xs-03-06, #item-slider-xs-03-05, #item-slider-xs-03-04, #item-slider-xs-03-03, #item-slider-xs-03-02, #item-slider-xs-03-01').removeClass('animation-item-left');
//         $('#item-slider-xs-03-06, #item-slider-xs-03-05, #item-slider-xs-03-04, #item-slider-xs-03-03, #item-slider-xs-03-02, #item-slider-xs-03-01').removeClass('animation-item-right');
//         $('#item-slider-xs-03-05').addClass('animation-item-left');
//       } else{
//         $('#item-slider-xs-03-06, #item-slider-xs-03-05, #item-slider-xs-03-04, #item-slider-xs-03-03, #item-slider-xs-03-02, #item-slider-xs-03-01').removeClass('animation-item-left');
//         $('#item-slider-xs-03-06, #item-slider-xs-03-05, #item-slider-xs-03-04, #item-slider-xs-03-03, #item-slider-xs-03-02, #item-slider-xs-03-01').removeClass('animation-item-right');
//         $('#item-slider-xs-03-05').addClass('animation-item-right');
//       }
//       break;
//     case "main-slider-xs-03-04":
//       if(directionSlide === "left") {
//         $('#item-slider-xs-03-06, #item-slider-xs-03-05, #item-slider-xs-03-04, #item-slider-xs-03-03, #item-slider-xs-03-02, #item-slider-xs-03-01').removeClass('animation-item-left');
//         $('#item-slider-xs-03-06, #item-slider-xs-03-05, #item-slider-xs-03-04, #item-slider-xs-03-03, #item-slider-xs-03-02, #item-slider-xs-03-01').removeClass('animation-item-right');
//         $('#item-slider-xs-03-04').addClass('animation-item-left');
//       } else{
//         $('#item-slider-xs-03-06, #item-slider-xs-03-05, #item-slider-xs-03-04, #item-slider-xs-03-03, #item-slider-xs-03-02, #item-slider-xs-03-01').removeClass('animation-item-left');
//         $('#item-slider-xs-03-06, #item-slider-xs-03-05, #item-slider-xs-03-04, #item-slider-xs-03-03, #item-slider-xs-03-02, #item-slider-xs-03-01').removeClass('animation-item-right');
//         $('#item-slider-xs-03-04').addClass('animation-item-right');
//       }
//       break;
//     case "main-slider-xs-03-03":
//       if(directionSlide === "left") {
//         $('#item-slider-xs-03-06, #item-slider-xs-03-05, #item-slider-xs-03-04, #item-slider-xs-03-03, #item-slider-xs-03-02, #item-slider-xs-03-01').removeClass('animation-item-left');
//         $('#item-slider-xs-03-06, #item-slider-xs-03-05, #item-slider-xs-03-04, #item-slider-xs-03-03, #item-slider-xs-03-02, #item-slider-xs-03-01').removeClass('animation-item-right');
//         $('#item-slider-xs-03-03').addClass('animation-item-left');
//       } else{
//         $('#item-slider-xs-03-06, #item-slider-xs-03-05, #item-slider-xs-03-04, #item-slider-xs-03-03, #item-slider-xs-03-02, #item-slider-xs-03-01').removeClass('animation-item-left');
//         $('#item-slider-xs-03-06, #item-slider-xs-03-05, #item-slider-xs-03-04, #item-slider-xs-03-03, #item-slider-xs-03-02, #item-slider-xs-03-01').removeClass('animation-item-right');
//         $('#item-slider-xs-03-03').addClass('animation-item-right');
//       }
//       break;
//     case "main-slider-xs-03-02":
//       if(directionSlide === "left") {
//         $('#item-slider-xs-03-06, #item-slider-xs-03-05, #item-slider-xs-03-04, #item-slider-xs-03-03, #item-slider-xs-03-02, #item-slider-xs-03-01').removeClass('animation-item-left');
//         $('#item-slider-xs-03-06, #item-slider-xs-03-05, #item-slider-xs-03-04, #item-slider-xs-03-03, #item-slider-xs-03-02, #item-slider-xs-03-01').removeClass('animation-item-right');
//         $('#item-slider-xs-03-02').addClass('animation-item-left');
//       } else{
//         $('#item-slider-xs-03-05, #item-slider-xs-03-04, #item-slider-xs-03-03, #item-slider-xs-03-02, #item-slider-xs-03-01').removeClass('animation-item-left');
//         $('#item-slider-xs-03-05, #item-slider-xs-03-04, #item-slider-xs-03-03, #item-slider-xs-03-02, #item-slider-xs-03-01').removeClass('animation-item-right');
//         $('#item-slider-xs-03-02').addClass('animation-item-right');
//       }
//       break;
//     default:
//       if(directionSlide === "left") {
//         $('#item-slider-xs-03-05, #item-slider-xs-03-04, #item-slider-xs-03-03, #item-slider-xs-03-02, #item-slider-xs-03-01').removeClass('animation-item-left');
//         $('#item-slider-xs-03-05, #item-slider-xs-03-04, #item-slider-xs-03-03, #item-slider-xs-03-02, #item-slider-xs-03-01').removeClass('animation-item-right');
//         $('#item-slider-xs-03-01').addClass('animation-item-left');
//       } else{
//         $('#item-slider-xs-03-05, #item-slider-xs-03-04, #item-slider-xs-03-03, #item-slider-xs-03-02, #item-slider-xs-03-01').removeClass('animation-item-left');
//         $('#item-slider-xs-03-05, #item-slider-xs-03-04, #item-slider-xs-03-03, #item-slider-xs-03-02, #item-slider-xs-03-01').removeClass('animation-item-right');
//         $('#item-slider-xs-03-01').addClass('animation-item-right');
//       }
//       break;
//   }
// })
