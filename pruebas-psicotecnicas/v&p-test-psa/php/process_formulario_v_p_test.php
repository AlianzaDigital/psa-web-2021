...
// TELEFONO FIJO
if (empty($_POST["telephone_line"])) {
    $errorMSG .= utf8_decode("Complete este campo");
} else {
    $telephone_line = $_POST["telephone_line"];
}
...
$params = array(
    ...
    'puesto' => ($funciones),
    'movil' => ($telephone),
    'telefono' => ($telephone_line),
    'correo' => ($email),
    'origen' => ('Campaña Google Ads 8850-55')
    'comentarios' => ("Nuevo lead PSA 2020: Formulario TenDisc")." | ".("NIT: ".$nit)." | ".("Proceso Seleccion: ".$proceso_seleccion)
...
$Subject = "Nuevo lead PSA 2020: Formulario TenDisc";
...
$Body .= utf8_decode($telephone_line);
$Body .= "\n";
